...
<img width="1179" height="816" alt="Cuplikan layar 2026-05-07 020323" src="https://github.com/user-attachments/assets/ac2dc03e-421a-4deb-9cdf-385df88b26a0" />
...
Pada baris ke-20, menampilkan atau mencetak data kursi, yang ada di array.

Pada baris ke-21, while true adalah pengulangan yang terus terjadi ketika nilai inputannya benar. User akan diminta untuk menginputkan nomor kursi yang ingin dicari sebagai target, apabila yang di masukan bukan angka maka menampilkan "Input tidak valid, silakan masukkan angka!"
...
Pada baris ke-27, "pos = binary_search(data, n, target):" yaitu memanggil fungsi pencarian yang kita bahas di atas.

<img width="1529" height="339" alt="Cuplikan layar 2026-05-07 020330" src="https://github.com/user-attachments/assets/5b17a708-e348-46cb-80eb-a2fae097a7eb" />

Pada baris ke-28, "if pos != -1:" artinya jika ditemukan (indeks bukan -1) maka akan terjadi 2 kondisi yaitu kondisi pertama "if 0 <= pos <= 3:" yaitu mengecek apakah indeks berada di rentang 0-3 (Baris depan), apabila iya akan mencetak "Kursi {target}(nomor kursi yang di cari) ditemukan pada indeks ke-{pos} maka, posisi baris depan". Kondisi Kedua "if 4 <= pos <= 7:" yaitu mengecek apakah indeks berada di rentang 4-7 (Baris belakang),pabila iya akan mencetak "Kursi {target}(nomor kursi yang di cari) ditemukan pada indeks ke-{pos} maka, posisi baris belakang".

Pada baris ke-33, jika semua kondisi di atasnya tidak terpenuhi maka akan mencetak "Nomor kursi tidak ditemukan dalam daftar."

Pada baris ke-37, sampai baris ke-40, "if __name__ == "__main__": main():" Baris ini adalah entry point. Ini memerintahkan Python untuk menjalankan fungsi main() saat file dieksekusi secara langsung.
